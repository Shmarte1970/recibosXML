...
/*
     ...
     $to = "pedro.rios@zarca.es, riosmacias@gmail.com";
     $subject = "Informe de Recibos Erróneos - " . date("Y-m-d");
     $message = "Adjunto encontrará el informe de recibos erróneos generado el " . date("Y-m-d H:i:s");
 
     // Guardar los detalles del correo en un archivo de log
     $log_file = 'email_log.txt';
     $log_content = "Fecha: " . date("Y-m-d H:i:s") . "\n";
     $log_content .= "Para: $to\n";
     $log_content .= "Asunto: $subject\n";
     $log_content .= "Mensaje: $message\n";
     $log_content .= "Archivo adjunto: $archivo_txt\n\n";
 
     file_put_contents($log_file, $log_content, FILE_APPEND);
 
     echo "<script>alert('Simulación de envío de correo completada. Revisa el archivo email_log.txt para ver los detalles.');</script>";
 
     // Mostrar el contenido del archivo en la consola para depuración
     $file_content = file_get_contents($archivo_txt);
     echo "<script>console.log('Contenido del archivo $archivo_txt:', " . json_encode($file_content) . ");</script>";
 */
